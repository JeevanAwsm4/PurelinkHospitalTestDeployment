...
export default function AllContacts({ setShowAllContacts }: AllContactsProps) {
  const goBack = () => {
          ...
          <div key={index} className="w-full h-full">
            <div className="flex items-center gap-6 lg:flex-row flex-col">
              ...
              <div className="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-2 hover:shadow-sm transition-shadow w-full h-full bg-white rounded-lg border py-3 px-6 text-sm">
                ...
                <p className="leading-loose text-gray-500 font-medium">
                  Requested Date <br />
                  <span className="text-gray-700">{request.requestedDate}</span>
                </p>
                <p className="leading-loose text-gray-500 font-medium">
                ...
                <p className="leading-loose text-gray-500 font-medium">
                  Serial No <br />
                  <span className="text-gray-700">{request.serialNumber}</span>
                </p>
                <p className="leading-loose text-gray-500 font-medium">
                  Full Name <br />
                  <span className="text-gray-700">{request.fullName}</span>
                </p>
                <p className="leading-loose text-gray-500 font-medium">
                  Phone Number <br />
                ...
                <p className="leading-loose text-gray-500 font-medium">
                  Blood Group <br />
                  <span className="text-gray-700">{request.bloodGroup}</span>
                </p>
              </div>
            </div>
          </div>
